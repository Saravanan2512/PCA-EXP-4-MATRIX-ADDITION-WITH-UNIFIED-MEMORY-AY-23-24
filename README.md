...
With memset:
```
<img width="488" height="82" alt="image" src="https://github.com/user-attachments/assets/fe1ce383-810f-40ac-81ef-1fe2d5ca064b" />

```
Without Memset:
```
<img width="470" height="79" alt="image" src="https://github.com/user-attachments/assets/58e97e6d-f84c-4f56-9aab-843262013162" />



## RESULT:
Thus the program has been executed by using unified memory. It is observed that removing memset function has given less/more more time.
